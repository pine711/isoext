...
from deuring.klpt import DecompAlphaN
from deuring.torsionbasis import torsiongen_old, torsiongen_new, torsiongen_BGDS
from deuring.torsionbasis import compute_hk
proof.all(False)
